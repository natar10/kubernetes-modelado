...
\begin{itemize}
    ...
    \item \textbf{RQ-02 Tolenacia a fallos parciales. }El sistema debe tolerar fallos parciales: si un servicio externo (Google Calendar, SMTP) o un microservicio interno no está disponible, las operaciones principales deben seguir funcionando de forma degradada.
    ...
    \item \textbf{RQ-06 Interaccción web. }El usuario final debe poder interactuar con el sistema a través de una aplicación web.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{RQ-24 Llamadas de escritua ordenadas.} En caso de inscripciones simultáneas a un torneo con plazas limitadas, el sistema
...
\begin{itemize}
    ...
    \item \textbf{RQ-33 Orquestación de despegue.} El orden de arranque debe respetar las dependencias entre servicios, garantizando
